...
//*/
{
	...
	.ac_trace_delay			= {3,32+10,32+10,32+10,32,32+10,32+10,32+20,32+10,32+10},
	.ddr_dmc_remap			= {
							[0] = ( 5 |  7 << 5 |  8 << 10 |  9 << 15 | 10 << 20 | 11 << 25 ),
							[1] = ( 12|  0 << 5 |  0 << 10 | 14 << 15 | 15 << 20 | 16 << 25 ),
							[2] = ( 17| 18 << 5 | 19 << 10 | 21 << 15 | 22 << 20 | 23 << 25 ),
	 ...
	 */
	.pll_ssc_mode			= (1<<20) | (1<<8) | (8<<4) | 0,//center_ssc_4000ppm
...
#else
	/* Enable 5V_EN ,set gpioao_8 low --> several millisecond--set high in board_init*/
	{AO_GPIO_O_EN_N,    (0 << 8),                (1 << 8),     0, BL2_INIT_STAGE_1, 0},
	{AO_GPIO_O,         (0 << 8),                (1 << 8),   0, BL2_INIT_STAGE_1, 0},
#endif

	/* MUST BE enable WOL_POWER ,set gpioao_3 HIGH*/
	{AO_GPIO_O_EN_N,    (0 << 3),                (1 << 3),     0, BL2_INIT_STAGE_1, 0},

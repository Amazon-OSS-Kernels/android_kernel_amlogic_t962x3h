...
#define LCD_EXT_CMD_TYPE_CMD_BIN_DATA2  0x90 /* use ini start reg */
#define LCD_EXT_CMD_TYPE_CMD2_BIN_DATA2 0x91 /* for i2c device 2nd addr */
#define LCD_EXT_CMD_TYPE_CMD3_BIN_DATA2 0x92 /* for i2c device 3rd addr */
#define LCD_EXT_CMD_TYPE_CMD4_BIN_DATA2 0x93 /* for i2c device 4th addr */

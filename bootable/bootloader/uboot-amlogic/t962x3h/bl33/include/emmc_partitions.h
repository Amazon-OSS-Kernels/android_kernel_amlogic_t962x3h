...
#define MMC_DDR_PARAMETER_NAME	"ddr_parameter"
...
#define VP_FLAG_BASE_USER	(0x1<<0)
#define VP_FLAG_BASE_BOOT0	(0x1<<1)
#define VP_FLAG_BASE_BOOT1	(0x1<<2)
#define VP_FLAG_BASE_RSV	(0x1<<3)
...
#define VIRTUAL_PARTITION_ELEMENT(na, of, sz, f) {.name = na, .offset = of, .size = sz, .flag = f}

...
static void store_block(void* dev, unsigned long long offset, const void* data, unsigned int len)
{
	...
	pdev->write(pdev, (uchar*)data, offset, len);
	s_dump_process += len;
...
struct compress_segment_request segment_reqs[5] = {
	{ /* segment 1: region 0x8C000000-0xB8DFFFFF; normal compress */
	.start_phyaddr = (mz_uint8 *)0x8C000000,
	.seg_origin_size = 0x2CE00000,
	.seg_order = 5,
	...
	{ /* segment 4: region 0x82000000-0x8BFFFFFF; normal compress */
	.start_phyaddr = (mz_uint8 *)0x82000000,
	.seg_origin_size = 0xA000000,
	.seg_order = 4,
	.compress_type = BOOTC_NORMAL_COMPRESS,
	},
...
struct compress_fullram_request compress_req = {
	.compress_to_phyaddr = (mz_uint8 *)0x8C000000,
	.total_memsize = 0x38E00000,
	...
	.progress_report_callback = mt_disp_show_memory_dump_process,

...
#define CONFIG_MDUMP_BUFFER_ADDRESS	0x4BFC0000
#endif

#ifndef COMPRESS_SCRATCH_ADDRESS
#define COMPRESS_SCRATCH_ADDRESS        0x4BF00000      // for compression data structure (size: 0x4df40)
#define COMPRESS_SCRATCH_SIZE           0x60000         // 384K total space for inflate data structure
#define COMPRESS_FIRST_BUFFER           0x4BF60000      // for holding initial compressed content

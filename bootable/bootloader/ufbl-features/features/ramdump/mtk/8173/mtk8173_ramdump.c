...
int check_ramdump(void)
{
	...
	dprintf(CRITICAL, "[%s]Check mdump buffer on addresss 0x%x.\n", MDUMP_MODULE, CONFIG_MDUMP_BUFFER_ADDRESS);
	...
	if (g_boot_arg->boot_reason == BR_POWER_KEY ||
		...
		if (g_boot_arg->boot_reason == BR_POWER_KEY)
			dprintf(CRITICAL, "Skip MDump due to Cold reset.\n");
		else
			dprintf(CRITICAL, "Skip MDump due to USB/AC boot after Power off.\n");
...
struct compress_segment_request segment_reqs[5] = {
	/* segment 1: region 0x51000000-0xA887FFFF; normal compress */
    {
	.start_phyaddr = (mz_uint8 *)0x58000000,
	.seg_origin_size = 0x50880000,
	.seg_order = 5,
	.compress_type = BOOTC_NORMAL_COMPRESS,
	},
	{ /* segment 2: region 0x40000000-0x41DFFFFF; normal compress */
	.start_phyaddr = (mz_uint8 *)0x40000000,
	.seg_origin_size = 0x1E00000,
	.seg_order = 2,
	.compress_type = BOOTC_NORMAL_COMPRESS,
	},
	{ /* segment 3: region 0x41E00000-0x427FFFFF;
	     lk/mdump/scratch area, skip (fill area with 0) */
	.start_phyaddr = (mz_uint8 *)0x41E00000,
	.seg_origin_size = 0xA00000,
	.seg_order = 3,
	.compress_type = BOOTC_ALL_SAME,
	.same_val_in_byte = 0,
	},
	{ /* segment 4: region 0x42800000-0x50FFFFFF; normal compress */
	.start_phyaddr = (mz_uint8 *)0x42800000,
	.seg_origin_size = 0x15800000,
	.seg_order = 4,
	.compress_type = BOOTC_NORMAL_COMPRESS,
	},
...
struct compress_fullram_request compress_req = {
	.compress_to_phyaddr = (mz_uint8 *)0x58000000,
	.total_memsize = 0x68880000,
	.scratch_phyaddr = (mz_uint8 *)0x42700000,
	.scratch_area_size = 0x60000,
	.first_compress_buffer = (mz_uint8 *)0x42760000,
	.first_buffer_size = 0x60000,
	.chunk_upper_limit = 64*COMPRESS_1MB,
	.num_of_segments = 5,
	.seg_reqs = segment_reqs,
	.progress_report_callback = NULL, //mt_disp_show_mdump_progress,

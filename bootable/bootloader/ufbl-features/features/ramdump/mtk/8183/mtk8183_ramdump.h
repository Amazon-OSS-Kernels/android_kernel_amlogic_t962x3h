...
#define CONFIG_MDUMP_BUFFER_ADDRESS	0x602C0000 /* setting by project */
#endif


#ifndef CONFIG_MDUMP_RESERVED_ADDRESS
#define CONFIG_MDUMP_RESERVED_ADDRESS 0x60000000 /* setting by project */
#define CONFIG_MDUMP_RESERVED_SIZE 0x300000
#endif


#ifndef COMPRESS_START_ADDRESS
#define COMPRESS_START_ADDRESS          (CONFIG_MDUMP_RESERVED_ADDRESS + CONFIG_MDUMP_RESERVED_SIZE)      // start address for storing compressed content
#endif

#ifndef COMPRESS_SCRATCH_ADDRESS
#define COMPRESS_SCRATCH_ADDRESS        (CONFIG_MDUMP_RESERVED_ADDRESS + 0x200000)      // for compression data structure (size: 0x4df40)
#define COMPRESS_SCRATCH_SIZE           0x60000         // 384K total space for inflate data structure
#define COMPRESS_FIRST_BUFFER           (COMPRESS_SCRATCH_ADDRESS + COMPRESS_SCRATCH_SIZE)     // for holding initial compressed content

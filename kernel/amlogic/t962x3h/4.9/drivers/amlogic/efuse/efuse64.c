	...
	struct class_attribute *attr, char *buf)
{
	...
	arm_smccc_smc(EFUSE_OBJ_READ, EFUSE_OBJ_LICENSE_ENABLE_USB_BOOT_PASSWORD,
		      32, 0, 0, 0, 0, 0, &res);
...
static struct class_attribute efuse_class_attrs[] = {
	...
	__ATTR(usb_boot_disable, 0600, show_usb_boot, store_usb_boot),

	__ATTR(usb_password_protect, 0600, show_usb_password_protect, store_usb_password_protect),

...
#define PR_DBG(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_INFO) { \
...
#define PR_ATSC(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_ATSC) { \
			printk("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)
...
#define PR_DVBC(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_DVBC) { \
...
#define PR_DVBT(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_DVBT) { \
			pr_info("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)
...
#define PR_DVBS(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_DVBS) { \
			pr_info("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)
...
#define PR_DTMB(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_DTMB) { \
			pr_info("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)
...
#define PR_ISDBT(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_ISDBT) { \
			pr_info("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)
...
#define PR_DBGL(fmt, args ...) \
	do { \
		if ((aml_demod_debug | inner_demod_debug) & DBG_LOOP) { \
			pr_info("dtv_dmd:"fmt, ##args); \
		} \
	} while (0)

...
static ssize_t dump_grid_read(struct class *cla,
					struct class_attribute *attr, char *buf)
{
...
static ssize_t dump_grid_write(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	unsigned long tmp;
...
static ssize_t bypass_decontour_read(struct class *cla,
					struct class_attribute *attr, char *buf)
{
...
static ssize_t  bypass_decontour_write(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	unsigned long tmp;
...
static ssize_t debug_decontour_read(struct class *cla,
					struct class_attribute *attr, char *buf)
{
...
static ssize_t  debug_decontour_write(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	unsigned long tmp;
...
static ssize_t i_do_decontour_read(struct class *cla,
					struct class_attribute *attr, char *buf)
{
...
static ssize_t  i_do_decontour_write(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	unsigned long tmp;
...
static ssize_t reg_read_write(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	unsigned long tmp;
	...
	pr_info("set reg is  %lx\n", tmp);
	reg = Rd(tmp);
	pr_info("reg_read is  %ld, value=%x\n", tmp, reg);
	return count;
}
...
__ATTR(orientation,
	...
	__ATTR(dump_grid,
	       ...
	       dump_grid_read,
	       dump_grid_write),
	__ATTR(bypass_decontour,
	       0644,
	       bypass_decontour_read,
	       bypass_decontour_write),
	__ATTR(debug_decontour,
	       0644,
	       debug_decontour_read,
	       debug_decontour_write),
	__ATTR(i_do_decontour,
	       0644,
	       i_do_decontour_read,
	       i_do_decontour_write),
	__ATTR(reg_read,
	       0644,
	       NULL,
	       reg_read_write),
...
static int ppmgr_driver_probe(struct platform_device *pdev)
{
	...
	pr_info("ppmgr_driver_probe: irq:%d\n", irq);
	...
	if (irq != 0) {
		...
		pr_info("ppmgr_driver_probe:request_irq: ret:%d\n", ret);
	}

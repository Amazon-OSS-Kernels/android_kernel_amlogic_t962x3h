...
struct lcd_tcon_config_s {
	...
	unsigned int reg_od_demo;
	unsigned int bit_od_demo_en;
...
#define REG_OD_DEMO_T5                   0x240
#define BIT_OD_DEMO_EN_T5                1
...
#define REG_OD_DEMO_T5D                   0x240
#define BIT_OD_DEMO_EN_T5D                1

...
static struct work_struct other_dump_work;
...
static void lowmem_dump_others(struct work_struct *work)
{
...
static int __init lowmem_init(void)
{
	...
	if (lmk_log_buffer) {
		INIT_WORK(&other_dump_work, lowmem_dump_others);

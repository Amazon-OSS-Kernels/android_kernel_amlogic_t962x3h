...
#define CLKID_SMARTCARD				(GATE_BASE0 + 23)
...
#define CLKID_CIPLUS				(GATE_BASE2 + 7)
#define CLKID_CLK81_TS				(GATE_BASE2 + 8)
#define CLKID_VPU_INTR				(GATE_BASE2 + 9)
#define CLKID_DEMOD_COMB			(GATE_BASE2 + 10)

...
#define GAMMA_READ_B                BIT(9)
#define GAMMA_READ_G                BIT(8)
#define GAMMA_READ_R                BIT(7)
...
#define AMVECM_IOC_G_HIST_AVG   _IOR(_VE_CM, 0x22, struct ve_hist_s)
...
#define AMVECM_IOC_G_HIST_BIN   _IOR(_VE_CM, 0x26, struct vpp_hist_param_s)
...
/*HDR10_TM_STATE COMMAND LIST*/
#define AMVECM_IOC_S_HDR10_TM_STATE  _IOW(_VE_CM, 0x6d, enum hdr10_tm_state)
#define AMVECM_IOC_G_HDR10_TM_STATE  _IOR(_VE_CM, 0x6e, enum hdr10_tm_state)

...
/*
Maximum wakeup source is 16, so define REMOTE_CUSTOM4_WAKEUP as REMOTE_CUS_WAKEUP(Customer power key)
AUTO_WAKEUP is unused, also be used to Custom remote wake up
*/
#define REMOTE_CUSTOM4_WAKEUP	REMOTE_CUS_WAKEUP

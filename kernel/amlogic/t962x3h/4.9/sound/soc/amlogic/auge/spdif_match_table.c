...
struct spdif_chipinfo t5_spdif_a_chipinfo = {
	.id           = SPDIF_A,
	.chnum_en     = true,
	.hold_start   = true,
	.eq_drc_en    = true,
...
struct spdif_chipinfo t5_spdif_b_chipinfo = {
	.id           = SPDIF_B,
	.chnum_en     = true,
	.hold_start   = true,
	.eq_drc_en    = true,
...
static const struct of_device_id aml_spdif_device_id[] = {
	...
	{
		.compatible = "amlogic, t5-snd-spdif-a",
		.data       = &t5_spdif_a_chipinfo,
	},
	{
		.compatible = "amlogic, t5-snd-spdif-b",
		.data       = &t5_spdif_b_chipinfo,
	},
	{},
};
